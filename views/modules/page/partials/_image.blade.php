@php
    ...
    switch ($img->position) {
        case 'top':
            $img->class->push('img-responsive mb20');
            break;
        case 'bottom':
            $img->class->push('img-responsive mt20');
            break;
        case 'left':
            $img->class->push('pull-left mr20 mb20');
            break;
        case 'right':
...
@if(@$page->settings->show_gallery)
    @include('page::partials._gallery')
@else
    {!! $html !!}
@endif