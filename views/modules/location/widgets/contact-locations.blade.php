<div class="contact-locations">
    @foreach($locations as $location)
        <div class="location">
            ...
            <div class="d-flex">
                <div class="info">
                    <a href="https://www.google.com/maps/dir/Current+Location/{{ setting('contact::contact-map-lat').','.setting('contact::contact-map-lng') }}" class="btn btn-default mt-15 pull-right btn-xs" target="_blank"><i class="fa fa-map-marker"></i> YOL TARİFİ AL</a>
                </div>
            </div>
        </div>
    @endforeach
